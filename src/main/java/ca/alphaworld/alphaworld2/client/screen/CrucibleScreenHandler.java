...
public class CrucibleScreenHandler extends ScreenHandler {
    ...
    public CrucibleScreenHandler(int syncId, PlayerInventory inventory, PacketByteBuf buf) {
        this(syncId, inventory, inventory.player.getWorld().getBlockEntity(buf.readBlockPos()),
                new ArrayPropertyDelegate(2));
    }

    public CrucibleScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity entity, PropertyDelegate delegate) {
        super(AlphaWorld2ScreenHandlers.CRUCIBLE_SCREEN_HANDLER, syncId);
